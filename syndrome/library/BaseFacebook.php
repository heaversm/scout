...
abstract class BaseFacebook
{
   ...
   * @#3658 AYI modification - lowered timeouts
   */
   ...
   * @#3658 AYI modifiaction - check for a blank signed request
   */
    ...
    if (isset($_REQUEST['code'])) {
      if ($this->state !== null &&
        ...
        return $_REQUEST['code'];
      	...
      	//see my comments here: https://github.com/facebook/php-sdk/issues/397
   ...
   * @#3658 AYI modification - fix undefined offset in signed request
   */
